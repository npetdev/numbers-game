      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.instructionsPage}>
          ...
          <ol>
            ...
            <li>
              After each roll, click on the numbers that match your chosen
              number to “hold” them. Held numbers will no longer change.
            </li>
            <li>
              The goal is to make <strong>all rolling numbers</strong> match
              your chosen number.
            </li>
            <li>
              The game ends successfully when all numbers are held and match
              your chosen number. Try to achieve this with as few{" "}
